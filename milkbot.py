...
async def send_pdf(chat_id):
    path = os.path.abspath('/home/milkyland_tg_bot/milky_bot/Прайс-лист фирменных киосков “MilkyLand”.pdf')
    with open(path, 'rb') as pdf_prices:

        await bot.send_document(chat_id, pdf_prices, caption='Цены на товары')

# /home/milkyland_tg_bot/milky_bot/Прайс-лист фирменных киосков “MilkyLand”.pdf
...
12 мкр, 39А (угол Богенбай батыра)\n
...
Абилкайыр хана, 80, р-н Сазда, сзади супермаркета Анвар \n

ул. Ахтанова, 59, напротив «Арай»\n

ул. Есет батыра, 105 около ТД «Жанар»\n

Авиагородок, 21, напротив магазина «у Ванюши» \n

Тургенева, 112, напротив «ЦОНа» \n

Богенбай батыра, 131а, мини - рынок «Табыс» \n
...
ул. Сатпаева, 11, около 23 школы\n

>>>>>>> a60730ef0731f42a9570415fe4f4b5415f8a1c95
...
р-н Гмз, ул. Гастелло, 18Б, мини-рынок «Табыс»\n

>>>>>>> a60730ef0731f42a9570415fe4f4b5415f8a1c95
пр. А. Молдагуловой, 30а, рынок "Алия", молочный отдел\n

Ш. Досмухамедулы, 59/1, ост. Колхозный рынок \n

Ш. Калдаякова, 27б, около ТД «Сабыр» \n
